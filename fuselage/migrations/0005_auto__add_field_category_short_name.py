...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('categories', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=20, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.short_name'
        db.delete_column('categories', 'short_name')
